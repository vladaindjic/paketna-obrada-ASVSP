...
STORE sortCompaniesAndProductsDesc INTO 'hdfs://namenode:8020/companiesAndProducts' USING CSVExcelStorage(',');
...
-- store results
STORE orderDescPercentage INTO 'hdfs://namenode:8020/percentageProductPerCompany' using CSVExcelStorage(',');
